...
RUN mkdir powershell-server
ADD assets/ powershell-server/
RUN chmod 755 /powershell-server/powershell-server.ps1
CMD [ "pwsh","/powershell-server/powershell-server.ps1" ]